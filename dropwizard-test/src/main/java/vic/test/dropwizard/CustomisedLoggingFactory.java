 ...
 */
@JsonTypeName("custom")
public class CustomisedLoggingFactory implements LoggingFactory {
    ...
    public CustomisedLoggingFactory() {
        this(LoggingUtil.getLoggerContext(), System.err);
    }

    @VisibleForTesting
    CustomisedLoggingFactory(LoggerContext loggerContext, PrintStream configurationErrorsStream) {
    ...
    public void configure(MetricRegistry metricRegistry, String name) {
        ...
        final LayoutFactory<ILoggingEvent> layoutFactory = getLayoutFactory();
    ...
    protected LayoutFactory<ILoggingEvent> getLayoutFactory() {
        return new CustomisedLayoutFactory();
    }

    private static class CustomisedLayoutFactory extends DropwizardLayoutFactory {
        @Override
        public PatternLayoutBase<ILoggingEvent> build(LoggerContext context, TimeZone timeZone) {
            return new MyLayout(context, timeZone);
        }

        private static class MyLayout extends DropwizardLayout {
            MyLayout(LoggerContext context, TimeZone timeZone) {
