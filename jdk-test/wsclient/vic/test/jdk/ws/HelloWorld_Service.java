 ...
 * 
 */
@WebServiceClient(name = "HelloWorld", targetNamespace = "http://ws.jdk.test.vic/", wsdlLocation = "http://localhost:9000/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLD_QNAME = new QName("http://ws.jdk.test.vic/", "HelloWorld");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://ws.jdk.test.vic/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.jdk.test.vic/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
